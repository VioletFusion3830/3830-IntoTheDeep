...
public class Arm {
    ...
    public Arm(){
        FtcServoActuator.Params armParams = new FtcServoActuator.Params()
                ...
                .setLogicalPosRange(RobotParams.ArmParams.LOGICAL_MIN_POS, RobotParams.ArmParams.LOGICAL_MAX_POS)
                .setPhysicalPosRange(RobotParams.ArmParams.PHYSICAL_MIN_POS, RobotParams.ArmParams.PHYSICAL_MAX_POS)
